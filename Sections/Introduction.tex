...
The documents also include a template for nice regression tables. Send it to the AI before letting it generate new tables from R/Stata output, so everything is neat and consistent. You can of course also use your own, just make it consistent across one document. 
