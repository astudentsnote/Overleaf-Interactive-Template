...
%\input{Titlepage_Options/Titlepage_Option1} % Suited for Bachelor's/Master's theses requiring formal author and supervisor contact blocks.
%\newpage

%\input{Titlepage_Options/Titlepage_Option2} % Suited for seminar papers, review papers, or term papers that reference one specific assigned source.
%\newpage

%\input{Titlepage_Options/Titlepage_Option3} % Conference-style papers or courses without strict formatting requirements, where a lighter visual feel is preferred.
%\newpage

%\input{Titlepage_Options/Titlepage_Option4} % Homework assignments. Starts on the same page (uses \vspace instead of \newpage) since a full title page is usually unnecessary here.
%\vspace{1cm}
